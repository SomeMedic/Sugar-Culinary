...
abstract class AppLocalizations {
  ...
  /// No description provided for @errorScrapingRecipe.
  ///
  /// In en, this message translates to:
  /// **'Error : this URL is not supported'**
  String get errorScrapingRecipe;
  ...
  /// No description provided for @noDifficultySelected.
  ///
  /// In en, this message translates to:
  /// **'No difficulty selected'**
  String get noDifficultySelected;

  /// No description provided for @noCostSelected.
  ///
  /// In en, this message translates to:
  /// **'No cost selected'**
  String get noCostSelected;
